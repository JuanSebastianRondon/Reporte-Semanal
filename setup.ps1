...
$form.Text = "Reporte Semanal - Configuración inicial"
...
$labelTitulo.Text = "Configura el envío de tu reporte"
...
$labelPass.Text = "Contraseña de aplicación (no tu password normal):"
...
$labelNota.Text = "Gmail no acepta tu contraseña normal para esto. Genera una`n" +
                   "'contraseña de aplicación' en myaccount.google.com/apppasswords`n" +
                   "y pega ese código de 16 caracteres aquí."
...
$boton.Add_Click({
    ...
    # Sin BOM: dotenv puede leer mal la primera línea si el archivo lo trae
    [System.IO.File]::WriteAllText($envPath, $envContent, (New-Object System.Text.UTF8Encoding($false)))

    $dataPath = Join-Path $AppDir "data.json"
    $dataContent = '{"apps":{},"totalSeconds":0}'
    [System.IO.File]::WriteAllText($dataPath, $dataContent, (New-Object System.Text.UTF8Encoding($false)))

    [System.Windows.Forms.MessageBox]::Show(
        "Listo. La app ya puede enviar tu reporte cada lunes.",
        "Configuración guardada", "OK", "Information"
    )
    $form.Close()
})
