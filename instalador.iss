...
[Files]
Source: "*"; DestDir: "{app}"; Flags: recursesubdirs ignoreversion; Excludes: "*.git,*node_modules,.env,*.log,.gitignore,instalador.iss, ejecutables.md, data.json,*.vscode,*dist,*build,.report-sent, *Output"
